  ...
  const validateForm = () => {
    ...
    if (step === 1) {
      if (!formData.accountNumber) {
        errors.accountNumber = 'Routing number is required';
      } else if (formData.accountNumber.length !== 10) {
        errors.accountNumber = 'Routing number must be 10 digits';
      }
          ...
          {step === 1 && (
            <div>
              ...
              <div className="flex items-center justify-between gap-20">
                <Link href="/dashboard" className="max-w-max flex items-center justify-center rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#002E3C] text-white">
                  Cancel
                </Link>
                <button type="button" className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#002E3C] text-white" onClick={handleNext}>
                  Next
                </button>
              </div>
            </div>
            ...
            <div>
              <div className="mb-3">
                ...
                <div className="flex gap-2 mt-2">
                  <div className="rounded-lg flex items-center justify-center w-[35px] h-[35px] bg-[#002E3C] text-white">WF</div>
          ...
          {step === 3 && (
            <div>
              ...
              <div className="flex items-center justify-between gap-20">
                ...
                <button type="submit" className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#002E3C] text-white">
                    ...
                    >
                      <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                        ...
                        <div className="mt-4">
                          <Link
                            href="/dashboard"
                            className="flex justify-center rounded-md border border-transparent bg-[#002E3C] px-4 py-2 text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                          >
                            Go Home
                          </Link>
                        </div>
