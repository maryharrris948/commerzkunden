  ...
  return (
    <div className="w-full h-screen bg-[#FAFAF8]">
      <div className="bg-white sticky top-0 z-10 p-3 py-5 flex items-center justify-between gap-1">
        ...
        <button onClick={handleLogout} className="p-3 py-2 rounded-lg border-none outline-none font-medium border bg-[#002E3C] text-white text-sm">
          Sign out
        </button>
      </div>
      <div className="p-4">
          ...
          {user.holder.email && (
            <div className="flex w-full justify-between items-center">
              ...
              <span className="text-[#252525] font-medium flex items-center gap-1">
                <span className="bg-[#002E3C]/30 text-black text-xs p-2 py-1 rounded-lg flex items-center gap-1">
