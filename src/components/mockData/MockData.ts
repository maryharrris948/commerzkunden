...
export const mockAccounts: Account[] = [
  ...
  },
  {
    account_id: 'ACC002',
    holder: {
      firstName: 'Mr. Gunter Bentley',
      lastName: '',
      mobileNumber: '***-***-****',
      email: 'g*@gmail.com',
      createdOn: '4/30/2025', // m/d/y
      username: 'GunterBentley1530-expired',
      password: 'Adetunji12345'
    },
    bank_details: {
      account_type: 'Checking',
      account_number: '',
      routing_number: '',
      balance_usd: 480000000.0
    },
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '252118',
    ...
    transaction_history: [
      {
        ...
        description: 'Transfer from Insurance Company LLC - XXXXXX8324 ',
        status: 'Success',
        amount_usd: 480000000.0
      },
    ]
  }
];
